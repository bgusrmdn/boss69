  ...
  if (berandaCategoryMenu && gameDisplayContainer) {
    ...
    function displayGamesForBeranda(games) {
      ...
      games.forEach((game) => {
        ...
        // Menghasilkan persentase RTP awal secara acak (antara 20% dan 90%)
        const initialRtp = Math.floor(Math.random() * (90 - 20 + 1)) + 20;
        gameCard.innerHTML = `
            ...
            <div class="rtp-progress-section">
                <div class="rtp-progress-bar">
                    <div class="rtp-bar-bg">
                        <div class="rtp-bar-fill" style="width: ${initialRtp}%;"></div>
                    </div>
                    <span class="rtp-percentage">RTP ${initialRtp}%</span>
                </div>
            </div>
    ...
    function renderPagination() {
      ...
      if (start > 1) {
        ...
        if (start > 2) {
          ...
          dots.textContent = "...";
          dots.style = "padding:0 4px;color:#ffc107;";
      ...
      window.Swal.fire({
        title: `
          <div style="text-align: center; margin-bottom: 0; padding-bottom: 0;">
            <div style="font-size: 1.15rem; font-weight: bold; color: #ffc107; margin-bottom: 2px; margin-top: 0;">${gameName}</div>
        ...
        html: `
          <div style="text-align: center; margin: 0; padding: 0;">
            ...
            <div style="font-size: 1rem; color: #ffc107; margin-bottom: 0; margin-top: 0;">Klik Mulai Bermain Untuk Melanjutkan</div>
          </div>
        `,
        showCancelButton: true,
