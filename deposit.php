                ...
                <div id="deposit-form-sections">
                    <div class="collapse show" id="qris-form-section" data-bs-parent="#deposit-form-sections">
                        <form id="deposit-qris-form" action="process_deposit_non_api.php" method="POST"> <input type="hidden" name="channel_type" value="qris">
                            ...
                            <div class="alert alert-info d-flex align-items-center mb-3" style="background: linear-gradient(80deg, #212529 30%, #ffc10766 100%); color: #fff; border: none; border-radius: 10px;">
                                <i class="fas fa-key fa-2x me-3" style="color:#ffc107;"></i>
                                <div>
                                    <div style="font-weight: bold; font-size: 1.05rem;">Kode Unik Deposit</div>
                                    <div style="font-size: 0.97rem;">Deposit wajib menggunakan <span style="color:#ffc107;font-weight:bold;">kode unik</span> di akhir nominal, contoh: <span style="color:#ffc107;font-weight:bold;">100.985</span> agar proses lebih cepat & otomatis.</div>
                                </div>
                            </div>
                            <div class="mb-3">
                    ...
                    <div class="collapse" id="bank-transfer-form-section" data-bs-parent="#deposit-form-sections">
                        <form id="deposit-bank-form" action="process_deposit_non_api.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="alert alert-info d-flex align-items-center mb-3" style="background: linear-gradient(90deg,#212529 60%,#ffc107 100%); color: #fff; border: none; border-radius: 10px;">
                                <i class="fas fa-key fa-2x me-3" style="color:#ffc107;"></i>
                                <div>
                                    <div style="font-weight: bold; font-size: 1.05rem;">Kode Unik Deposit</div>
                                    <div style="font-size: 0.97rem;">Deposit wajib menggunakan <span style="color:#ffc107;font-weight:bold;">kode unik</span> di akhir nominal, contoh: <span style="color:#ffc107;font-weight:bold;">100.985</span> agar proses lebih cepat & otomatis.</div>
