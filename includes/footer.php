...
<nav class="mobile-footer-nav d-lg-none fixed-bottom">
    ...
    ?>
        ...
        <a href="daftar" class="nav-item register-btn <?php echo ($current_page == 'daftar') ? 'active' : ''; ?>">
            <div class="nav-icon-block"><i class="fas fa-user-plus"></i></div>
        ...
        <a href="login" class="nav-item <?php echo ($current_page == 'login') ? 'active' : ''; ?>">
            <div class="nav-icon-block"><i class="fas fa-sign-in-alt"></i></div>
            ...
            <div class="footer-ppinfo container py-2 mb-3">
                <?php if ($payments): ?>
                    <div class="mb-2 d-flex align-items-center justify-content-center gap-2">
                        ...
                        <span class="fw-bold" style="font-size:1.08em;letter-spacing:0.5px;color:#ffe082;text-shadow:0 1px 4px #222;">Metode Pembayaran</span>
                    </div>
...
<!-- 🚀 ENHANCED OPTIMIZATIONS JS - Interaksi dan Animasi Keren! -->
<script src="<?php echo $base_url; ?>assets/js/optimization.js?v=<?php echo time(); ?>"></script>
