    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            Swal.fire({
                ...
                html: 'Selamat datang, <strong style=\"color: #ffc107;\">" . htmlspecialchars($success_username) . "</strong>!<br>Anda akan diarahkan ke halaman utama.',
                icon: 'success',
                ...
                confirmButtonColor: '#ffc107', // Warna tombol sesuai tema
